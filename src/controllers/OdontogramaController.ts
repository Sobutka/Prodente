...
export class OdontogramaController{
    async create(req: Request, res: Response){
        let { dataRealizacao, dente, face, valor, orcamento, procedimento} = req.body
        ...
        try {
            ...
            const newOdontograma = odontogramaRepository.create({ dataRealizacao, dente, face, valor, orcamento, procedimento})
